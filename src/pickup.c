...
STATIC_DCL void explain_container_prompt(boolean);
...
STATIC_DCL int do_loot_cont(struct obj **, int, int);
...
do_loot_cont(struct obj **cobjp,
             int cindex, int ccount) /* index of this container (1..N), number of them (N) */
{
