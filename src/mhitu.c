...
STATIC_DCL int passiveum(struct permonst *, struct monst *,
                         struct attack *);
STATIC_DCL void mayberem(struct monst *, const char *,
 ...
 */
int
could_seduce(struct monst *magr, struct monst *mdef, struct attack *mattk /* non-Null: current attack; Null: general capability */)
{
...
STATIC_OVL void
mayberem(struct monst *mon, const char *seducer /* only used for alternate message */,
