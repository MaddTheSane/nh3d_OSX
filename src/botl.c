...
STATIC_DCL void bot_via_windowport(void);
...
STATIC_DCL boolean eval_notify_windowport_field(int, boolean *, int);
STATIC_DCL void evaluate_and_notify_windowport(boolean *, int);
...
STATIC_DCL enum statusfields fldname_to_bl_indx(const char *);
STATIC_DCL boolean hilite_reset_needed(struct istat_s *, long);
STATIC_DCL boolean noneoftheabove(const char *);
STATIC_DCL struct hilite_s *get_hilite(int, int, genericptr_t,
                                               int, int, int *);
STATIC_DCL void split_clridx(int, int *, int *);
STATIC_DCL boolean is_ltgt_percentnumber(const char *);
STATIC_DCL boolean has_ltgt_percentnumber(const char *);
STATIC_DCL int splitsubfields(char *, char ***, int);
STATIC_DCL boolean is_fld_arrayvalues(const char *,
                                              const char *const *,
                                              int, int, int *);
STATIC_DCL int query_arrayvalue(const char *, const char *const *,
                                        int, int);
STATIC_DCL void status_hilite_add_threshold(int, struct hilite_s *);
STATIC_DCL boolean parse_status_hl2(char (*)[QBUFSZ], boolean);
STATIC_DCL char *conditionbitmask2str(unsigned long);
STATIC_DCL unsigned long match_str2conditionbitmask(const char *);
STATIC_DCL unsigned long str2conditionbitmask(char *);
STATIC_DCL boolean parse_condition(char (*)[QBUFSZ], int);
STATIC_DCL char *hlattr2attrname(int, char *, int);
STATIC_DCL void status_hilite_linestr_add(int, struct hilite_s *,
                                                unsigned long, const char *);
STATIC_DCL void status_hilite_linestr_done(void);
STATIC_DCL int status_hilite_linestr_countfield(int);
STATIC_DCL void status_hilite_linestr_gather_conditions(void);
STATIC_DCL void status_hilite_linestr_gather(void);
STATIC_DCL char *status_hilite2str(struct hilite_s *);
STATIC_DCL int status_hilite_menu_choose_field(void);
...
STATIC_OVL boolean
hilite_reset_needed(struct istat_s *bl_p, long augmented_time /* no longer augmented; it once encoded fractional
