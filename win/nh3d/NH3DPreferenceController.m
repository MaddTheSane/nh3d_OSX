...
- (void)changeFont:(id)sender
{
	...
	switch ( _fontButtonTag ) {
		case 1:		key = NH3DMsgFontKey;		sizeKey = NH3DMsgFontSizeKey;	break;
		case 2:		key = NH3DWindowFontKey;	sizeKey = NH3DWindowFontSizeKey;	break;
		case 3:		key = NH3DMapFontKey;		sizeKey = NH3DMapFontSizeKey;	break;
		case 4:		key = NH3DBoldFontKey;		sizeKey = NH3DBoldFontSizeKey;	break;
		case 5:		key = NH3DInventryFontKey;	sizeKey = NH3DInventryFontSizeKey;	break;
	}
...
- (IBAction)showFontPanelAction:(id)sender
{
	...
	switch ( _fontButtonTag ) {
		case 1:		key = NH3DMsgFontKey;		break;
		case 2:		key = NH3DWindowFontKey;	break;
		case 3:		key = NH3DMapFontKey;		break;
		case 4:		key = NH3DBoldFontKey;		break;
		case 5:		key = NH3DInventryFontKey;	break;
	}
	...
	familyName = [ [NSUserDefaults standardUserDefaults] objectForKey:key ];
...
- (IBAction)resetTileSettings:(id)sender
{
	...
	[ [NSUserDefaults standardUserDefaults] setObject:[ NSNumber numberWithInt:16 ] forKey:NH3DTileSizeWidthKey ];
	[ [NSUserDefaults standardUserDefaults] setObject:[ NSNumber numberWithInt:16 ] forKey:NH3DTileSizeHeightKey ];
	[ [NSUserDefaults standardUserDefaults] setObject:[ NSNumber numberWithInt:40 ] forKey:NH3DTilesPerLineKey ];
	[ [NSUserDefaults standardUserDefaults] setObject:[ NSNumber numberWithInt:30 ] forKey:NH3DNumberOfTilesRowKey ];
}
