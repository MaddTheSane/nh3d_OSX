...
const long numberOfMonsters = NUMMONS;

static NH3DMonsterDefines monsterDefines2[] = {
#pragma mark insects
#ifdef PM_GIANT_ANT
	{
		.number = PM_GIANT_ANT,
		.string = STRINGIFY(PM_GIANT_ANT),
	},
#endif
#ifdef PM_KILLER_BEE
	{
		.number = PM_KILLER_BEE,
		.string = STRINGIFY(PM_KILLER_BEE),
	},
#endif
#ifdef PM_FIRE_ANT
	{
		.number = PM_FIRE_ANT,
		.string = STRINGIFY(PM_FIRE_ANT),
	},
#endif
#ifdef PM_GIANT_BEETLE
	{
		.number = PM_GIANT_BEETLE,
		.string = STRINGIFY(PM_GIANT_BEETLE),
	},
#endif
#ifdef PM_QUEEN_BEE
	{
		.number = PM_QUEEN_BEE,
		.string = STRINGIFY(PM_QUEEN_BEE),
	},
#endif
#pragma mark blobs
...
//#define	PM_GELATINOUS_CUBE	8
	...
	{
		.number = PM_ACID_BLOB,
		.string = STRINGIFY(PM_ACID_BLOB),
	},
#endif
#ifdef PM_QUIVERING_BLOB
	{
		.number = PM_QUIVERING_BLOB,
		.string = STRINGIFY(PM_QUIVERING_BLOB),
	},
#endif
};
#ifdef PM_MAIL_DAEMON
{
	.number = PM_MAIL_DAEMON
	.string =
	},
#endif

NH3DMonsterDefines *monsterDefines = monsterDefines2;
